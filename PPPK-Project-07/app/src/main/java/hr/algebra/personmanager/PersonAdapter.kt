...
class PersonAdapter(private val context: Context, private val people: MutableList<Person>, private val navigable: Navigable)
    : RecyclerView.Adapter<PersonAdapter.ViewHolder>(){
        class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView){
            private val ivImage = itemView.findViewById<ImageView>(R.id.ivImage)
            private val tvTitle = itemView.findViewById<TextView>(R.id.tvTitle)
            internal val ivDelete = itemView.findViewById<ImageView>(R.id.ivDelete)
